...
After your project is set up, access the CMS at <http://localhost:8080/cms> and the site at <http://localhost:8080/channelconfigeditordemo>.
...
as com.bloomreach.xm/channel-config-editor-demo:0.1.0-SNAPSHOT
