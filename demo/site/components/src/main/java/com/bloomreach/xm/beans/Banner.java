...
@HippoEssentialsGenerated(internalName = "channelconfigeditordemo:bannerdocument")
@Node(jcrType = "channelconfigeditordemo:bannerdocument")
public class Banner extends BaseDocument {
	...
	public HippoGalleryImageSet getImage() {
		return getLinkedBean("channelconfigeditordemo:image", HippoGalleryImageSet.class);
	}

	@HippoEssentialsGenerated(internalName = "channelconfigeditordemo:link")
	public HippoBean getLink() {
		return getLinkedBean("channelconfigeditordemo:link", HippoBean.class);
	}
}
